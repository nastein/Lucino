...
subroutine det_J1Jdel_exc(res,nuc1_iso,spec_iso)
   implicit none
   integer*4 :: i1,f1,i2,f2,i,j,it1,it2
   integer*4 :: nuc1_iso !This is the isospin of the struck nucleon
   integer*4 :: spec_iso !This is the isospin of the spectator nucleon
   complex*16 :: nuc1_isospinor(2),nuc1p_isospinor(2), spec_isospinor(2)
   ...
   ctb = IDeltaBdag(spec_isospinor, nuc1p_isospinor, nuc1_isospinor, spec_isospinor)
   ctc = IDeltaCdag(spec_isospinor, nuc1p_isospinor, nuc1_isospinor, spec_isospinor)
...
subroutine det_JdelJdel_exc(res_re)
   ...
   return
    ...
    subroutine det_J1Jpi_exc(res,nuc1_iso,spec_iso)
   implicit none
   integer*4 :: i1,f1,i2,f2,i,j,it1,it2,spec_iso
   integer*4 :: nuc1_iso !This is the isospin of the struck nucleon
   complex*16 :: nuc1_isospinor(2), nuc1p_isospinor(2), spec_isospinor(2)
   ...
   ! We compute the complex conjugate of the exchange 
   ! so the ordering is < 2',1'| Jdag | 1, 2 >
   ctf = ctf - Ivminus(spec_isospinor,nuc1p_isospinor,nuc1_isospinor,spec_isospinor) 
   cts = cts - Ivminus(spec_isospinor,nuc1p_isospinor,nuc1_isospinor,spec_isospinor) 
   ctp = ctp - Ivminus(spec_isospinor,nuc1p_isospinor,nuc1_isospinor,spec_isospinor) 
