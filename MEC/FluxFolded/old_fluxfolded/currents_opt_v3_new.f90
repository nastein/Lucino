...
subroutine JDeltaFixed(jtot_V,jtot_A,ti1,ti2,tf1,tf2)
    ...
    jtot_V(:,:,:,:,tf2,tf1,ti2,ti1,:) = ja_V(:,:,:,:,:)*IsoDeltaA(tf2,tf1,ti2,ti1)
    jtot_V(:,:,:,:,tf2,tf1,ti2,ti1,:) = jtot_V(:,:,:,:,tf2,tf1,ti2,ti1,:) + jb_V(:,:,:,:,:)*IsoDeltaB(tf2,tf1,ti2,ti1)
    jtot_V(:,:,:,:,tf2,tf1,ti2,ti1,:) = jtot_V(:,:,:,:,tf2,tf1,ti2,ti1,:) + jc_V(:,:,:,:,:)*IsoDeltaC(tf2,tf1,ti2,ti1)
    jtot_V(:,:,:,:,tf2,tf1,ti2,ti1,:) = jtot_V(:,:,:,:,tf2,tf1,ti2,ti1,:) + jd_V(:,:,:,:,:)*IsoDeltaD(tf2,tf1,ti2,ti1)

    jtot_A(:,:,:,:,tf2,tf1,ti2,ti1,:) = ja_A(:,:,:,:,:)*IsoDeltaA(tf2,tf1,ti2,ti1)
    jtot_A(:,:,:,:,tf2,tf1,ti2,ti1,:) = jtot_A(:,:,:,:,tf2,tf1,ti2,ti1,:) + jb_A(:,:,:,:,:)*IsoDeltaB(tf2,tf1,ti2,ti1)
    jtot_A(:,:,:,:,tf2,tf1,ti2,ti1,:) = jtot_A(:,:,:,:,tf2,tf1,ti2,ti1,:) + jc_A(:,:,:,:,:)*IsoDeltaC(tf2,tf1,ti2,ti1)
    jtot_A(:,:,:,:,tf2,tf1,ti2,ti1,:) = jtot_A(:,:,:,:,tf2,tf1,ti2,ti1,:) + jd_A(:,:,:,:,:)*IsoDeltaD(tf2,tf1,ti2,ti1)
...
subroutine JPiFixed(jtot_V,jtot_A,ti1,ti2,tf1,tf2)
   ...
   enddo   
    ...
    jtot_V(:,:,:,:,tf2,tf1,ti2,ti1,:) = IsoPi(tf2,tf1,ti2,ti1)&
        & * (js1_V(:,:,:,:,:) + js2_V(:,:,:,:,:) + jf_V(:,:,:,:,:)&
        & + jp1_V(:,:,:,:,:) + jp2_V(:,:,:,:,:))

    jtot_A(:,:,:,:,tf2,tf1,ti2,ti1,:) = IsoPi(tf2,tf1,ti2,ti1)&
        & * (js1_A(:,:,:,:,:) + js2_A(:,:,:,:,:) + jf_A(:,:,:,:,:)&
        & + jp1_A(:,:,:,:,:) + jp2_A(:,:,:,:,:))
