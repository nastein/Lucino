...
!.......initialize normalization factors
    ...
    cpp2=sqrt((pp2(1)+xmn)/(2.0d0)*pp1(2))
!.....define sigma*p
    do i=1,3
...
subroutine current_init(p1_in,p2_in,pp1_in,pp2_in,q_in,w_in,k1_in,k2_in,i_fl_in,iso_in)
    implicit none
...
!   r_av(4,4)=(w/q(4))*r_av(1,1)
!   r_av(4,4)=(w/q(4))**2*r_av(1,1)
...
!!!! what we want to compute is
   ...
   r_exc(1,4)=(w/q(4))*r_exc(1,1)
   r_exc(4,4)=(w/q(4))*r_exc(1,1)
   r_exc(4,4)=(w/q(4))**2*r_exc(1,1)
