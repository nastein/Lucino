...
subroutine f_eval(w,i1,i2,i1p,i2p,pj1,pj2,np1,elepi,f,my_event_in)
   use event_module
   use mathtool
   use mympi
   use dirac_matrices
   ...
   real*8 :: elepf,w,plepf,cos_theta,sin_theta
   ...
   real*8 :: Vcc,Vcl,Vll,Vt,Vl,Rcc,Rcl,Rll,Rt,Rl
   ...
   sig = sig0*(real(Vcc*Rcc - 2.0d0*Vcl*Rcl + Vll*Rll + Vt*Rt))*1.e9
