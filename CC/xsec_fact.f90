  ...
  subroutine masses_in(xmin, xmout)
    ...
    subroutine sig_nuN_CCQE(xq,w,wt,probeP4,outlepP4,p_4, &
        &   pp_4,enu,xsec)
    use xsec_fact 
    use dirac_matrices 
    implicit none
    ...
    elept = enu - w
    !xklept = sqrt(outlepP4(1)**2 - outlepP4(2)**2 - outlepP4(3)**2 - outlepP4(4)**2)
    !write(6,*)'xkl
    ...
    sigmott = (G_Ft)**2/4.0d0/pi**2/hbarc**2 *2.0d0*pi
